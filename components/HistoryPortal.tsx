    ...
    <div className="max-w-4xl mx-auto space-y-10 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          ...
          <p className="text-slate-400 font-bold mt-2 leading-relaxed">Histórico completo das vistorias de saída e retorno da frota.</p>
        </div>
        ...
        >
          ...
          <p className="text-slate-400 font-bold mt-2 leading-relaxed">Histórico de abastecimentos de combustível, ARLA 32 e lubrificantes.</p>
        </div>
      </div>
    </div>
  );
