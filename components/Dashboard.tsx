...
const Dashboard: React.FC<DashboardProps> = ({ 
  ...
  const canAccessOS = user.role === 'ADMIN' || user.role === 'OPERACAO' || user.role === 'MANUTENCAO';
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-700">
      ...
      <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
        ...
        <button onClick={onNewRefueling} className="bg-[#58CC02] p-6 rounded-3xl text-white shadow-lg hover:translate-y-[-2px] transition-all duration-300 flex flex-col items-center justify-center text-center gap-4 group">
          ...
          <div className="space-y-1">
            <h3 className="text-sm font-black uppercase tracking-widest">Abastecer</h3>
        ...
        <button onClick={onNewLubricant} className="bg-[#FFA500] p-6 rounded-3xl text-white shadow-lg hover:translate-y-[-2px] transition-all duration-300 flex flex-col items-center justify-center text-center gap-4 group">
          ...
          <div className="space-y-1">
            <h3 className="text-sm font-black uppercase tracking-widest">Lubrificar</h3>
            <p className="text-[10px] font-bold text-orange-50 opacity-80">Óleo e Graxa</p>
          </div>
        </button>

        {canAccessOS && (
          <button onClick={onNewOS} className="bg-red-600 p-6 rounded-3xl text-white shadow-lg hover:translate-y-[-2px] transition-all duration-300 flex flex-col items-center justify-center text-center gap-4 group relative overflow-hidden">
            <div className="w-12 h-12 bg-white/10 rounded-2xl flex items-center justify-center backdrop-blur-md border border-white/10 group-hover:scale-110 transition-transform">
            ...
            <div className="space-y-1">
              <h3 className="text-sm font-black uppercase tracking-widest">Abrir O.S.</h3>
              <p className="text-[10px] font-bold text-red-100 opacity-80">Ordem de Serviço</p>
            </div>
          </button>
        )}

        {canAccessMaintenance && (
          <button onClick={onMaintenanceTimer} className="bg-slate-800 p-6 rounded-3xl text-white shadow-lg hover:translate-y-[-2px] transition-all duration-300 flex flex-col items-center justify-center text-center gap-4 group relative overflow-hidden">
            <div className="w-12 h-12 bg-white/10 rounded-2xl flex items-center justify-center backdrop-blur-md border border-white/10 group-hover:scale-110 transition-transform">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[10px] font-bold text-slate-300 opacity-80">Timer Efetivo</p>
            </div>
          </button>
        )}
      </div>
      ...
      <div className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4`}>
          <div className="bg-white p-5 rounded-3xl shadow-sm border border-slate-100 grid grid-cols-2 divide-x divide-slate-100">
            ...
            <div className="flex items-center gap-3 pl-4">
              ...
              <div>
                <p className="text-slate-500 text-[7px] font-black uppercase tracking-widest mb-0.5">Pendentes</p>
          ...
          <div className="bg-white p-5 rounded-3xl shadow-sm border border-slate-100 flex items-center gap-4">
            ...
            <div>
              <p className="text-slate-400 text-[8px] font-black uppercase tracking-widest mb-0.5">Insumos Hoje</p>
              <p className="text-2xl font-black text-[#0A2540]">{counts.refuelings + counts.lubricants}</p>
            </div>
          </div>
          ...
          {canAccessMaintenance && (
            <div className="bg-white p-5 rounded-3xl shadow-sm border border-slate-100 grid grid-cols-2 divide-x divide-slate-100">
              <div className="flex items-center gap-3 pr-4">
                ...
                <div>
                  <p className="text-slate-400 text-[7px] font-black uppercase tracking-widest mb-0.5">Oficina O.S.</p>
              ...
              <div className="flex items-center gap-3 pl-4">
                ...
                <div>
                  <p className="text-cyan-500 text-[7px] font-black uppercase tracking-widest mb-0.5">Trabalhando</p>
                  <div className="flex items-center gap-1">
